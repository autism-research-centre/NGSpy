...
cmnd = "path/pindel -f " + ref + " -i " + cfg + " -c ALL -o " + out6 + " -T 24"
print(cmnd)
os.system(cmnd)
...
#	cmnd = "path/pindel2vcf -p " + o1 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o1vcf
#	print(cmnd)
#	os.system(cmnd)
...
#	cmnd = "/path/pindel2vcf -p " + o2 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o2vcf
#	print(cmnd)
#	os.system(cmnd)
...
#	cmnd = "/path/pindel2vcf -p " + o3 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o3vcf
#	print(cmnd)
#	os.system(cmnd)
...
#	cmnd = "/path/pindel2vcf -p " + o4 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o4vcf
#	print(cmnd)
#	os.system(cmnd)	
...
# 	cmnd = "path/pindel2vcf -p " + o5 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o5vcf
# 	print(cmnd)
# 	os.system(cmnd)
# 
...
# 	cmnd = "patha/pindel2vcf -p " + o6 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o6vcf
# 	print(cmnd)
# 	os.system(cmnd)
# 
...
# 	cmnd = "path/pindel2vcf -p " + o7 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o7vcf
# 	print(cmnd)
# 	os.system(cmnd)
# 	
...
# 	cmnd = "path/pindel2vcf -p " + o8 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o8vcf
# 	print(cmnd)
# 	os.system(cmnd)
# 	
...
# 	cmnd = "path/pindel2vcf -p " + o9 + " -r " + ref + "  -R hg19 -d 20131217 -v " + o9vcf
# 	print(cmnd)
# 	os.system(cmnd)	
# 	
